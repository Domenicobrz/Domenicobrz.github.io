...
function init () { // Initialization
    ...
    window.reflectionCube = new THREE.CubeTextureLoader().load( urls, function(texture) {
        ...
        // window.sphereMaterial = new THREE.MeshStandardMaterial({
        //     color: 0xffffff,
        //     roughness: 0.05,
        //     // metallic: 0.0,
        //     envMapIntensity: 1.5,
        ...
        window.sphereMaterial = mobilePBRmaterial({
        ...
        sphereMaterial.uniforms.spec1.value = texture;
    ...
    //     sphereMaterial.uniforms.spec2.value = cubeMapTexture;
    // } );
