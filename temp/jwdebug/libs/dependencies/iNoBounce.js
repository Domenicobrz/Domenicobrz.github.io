...
(function(global) {
	...
	var handleTouchmove = function(evt) {
		...
		while (el !== document.body) {
			...
			var height = el.clientHeight; //parseInt(style.getPropertyValue('height'), 10);
	...
	var vertScroll = function(evt, height, el){
		...
		if (Ydiff > Xdiff) {
            // evt.preventDefault();
            // counter++;
            // debugOutput.textContent = counter + " blocked hor";
    ...
    window.addEventListener("load", function() {
        // document.querySelector(".view-container").appendChild(debugOutput);
