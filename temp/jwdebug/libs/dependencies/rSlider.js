 ...
 * 
 * the original script gathered just once the slider.getBoundingClientRect().left property,
 * while instead we may have the slider moved a lot more to the left initially because it's part of a panel,
 * the modification I made was to make sure that every time this.sliderLeft was referenced, the getBoundingClientRect().left
 * function was updating that value
 * */
	...
	RS.prototype.move = function (e) {
		if (this.activePointer && !this.conf.disabled) {
            ...
            var sliderLeft = this.slider.getBoundingClientRect().left;
			var coordX = e.type === 'touchmove' ? e.touches[0].clientX : e.pageX,
				index = coordX - sliderLeft - (this.pointerWidth / 2);
	...
	RS.prototype.setValues = function (start, end) {
		...
		if (this.conf.range) {
			...
			if (this.conf.tooltip)
				this.tipL.innerHTML = this.conf.values[this.values.end].toFixed(2);
	...
	RS.prototype.onClickPiece = function (e) {
        ...
        var sliderLeft = this.slider.getBoundingClientRect().left;
		var idx = Math.round((e.clientX - sliderLeft) / this.step);
